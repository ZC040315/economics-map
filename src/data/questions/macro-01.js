...
export default [
  ...
  // ---------- 报表分析题（5 道） ----------
  {
    ...
    options: ['900 亿元', '850 亿元', '700 亿元', '500 亿元'],
    answer: 0,
  ...
  },
  {
    ...
    table: {
      title: '表：某国两年 GDP',
      columns: ['年份', '名义 GDP', '实际 GDP（固定价格）'],
      rows: [
        ['2024', '1000 亿元', '1000 亿元'],
        ['2025', '1300 亿元', '1050 亿元'],
      ],
    },
  ...
  },
  {
    ...
    hint: '想想中间品的价值在哪里。',
    reference:
      '面包的 7 元里已经包含了小麦和面粉的全部价值（2+2+3=7）。如果把每个环节售价都加一遍（2+4+7=13），小麦和面粉的价值就被重复计算。只算最终品，恰好等于各环节新增价值的加总（2+2+3=7）。',
  },
  {
    ...
    table: {
      title: '表：某国两年经济数据',
      columns: ['年份', '名义 GDP 增速', '物价涨幅', '人口增速'],
      rows: [
        ['2024', '8%', '3%', '1%'],
        ['2025', '6%', '2%', '1%'],
      ],
