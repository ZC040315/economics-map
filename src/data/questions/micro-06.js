...
export default [
  ...
  },
  {
    ...
    reference:
      '均衡价下，愿意出更高价的买家（高消费者剩余）自然买到，不愿意出价的退出；成本更低的生产者（高生产者剩余）自然供应，高成本者退出。资源流向「估值最高」的人，没有被浪费——这正是总剩余最大化的含义。',
  },
  // ---------- 重点疑难题 ----------
  {
  ...
  },
  {
    ...
    reference:
      '垄断者把价格定得高于边际成本以赚取利润，导致一部分「愿意付的成本高于边际成本但低于垄断价」的买家买不起——这些本该成交的交易消失了，造成无谓损失，总剩余低于竞争均衡，市场不再效率最优。',
  },
  {
  ...
  },
  {
    ...
    reference:
      '价格低于均衡价时，成交数量减少。一部分原本会成交的买家（愿意出价高于新价但买不到）和卖家（愿意以高于新价卖但卖不出）都退出，他们本可获得的剩余消失——即图中「均衡数量与新数量之间」被切掉的那两块三角形，就是无谓损失。',
  },
  // ---------- 报表分析题（5 道） ----------
  {
    ...
    options: ['1000 元', '4000 元', '5000 元', '9000 元'],
    answer: 0,
  ...
  },
  {
    ...
    options: ['400 元', '800 元', '1200 元', '2000 元'],
    answer: 0,
  ...
  },
  {
    ...
    options: ['1400 元', '1000 元', '400 元', '600 元'],
    answer: 0,
  ...
  },
  {
    ...
    hint: '看总剩余少了的部分去了哪里。',
    reference:
      '垄断把价格抬高，一部分本可成交的交易没发生：消费者剩余从 5000 掉到 2000（其中一部分变成垄断者的生产者剩余，但还有一部分既没给消费者也没给生产者——就是无谓损失 1500）。总剩余减少说明资源被错配。',
  },
  {
